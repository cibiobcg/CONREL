    ...
    tabItems(
      ...
      tabItem(
        ...
        fluidPage(column(
          ...
          # valueBoxOutput(width=3,"tfbs_valueRender"),
          # valueBoxOutput(width=3,"tf_valueRender"),
          # valueBoxOutput(width=3,"cell_valueRender"),
          # valueBoxOutput(width=3,"cre_valueRender"),
          column(width=5,
